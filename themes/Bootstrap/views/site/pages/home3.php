<script type="text/javascript">
  var flashvars = {};
  flashvars.cssSource = "<?php echo Yii::app()->theme->baseUrl;?>/css/piecemaker.css";
  flashvars.xmlSource = "<?php echo Yii::app()->theme->baseUrl;?>/piecemaker.php?path=<?php echo Yii::app()->theme->baseUrl;?>";
  ...
  swfobject.embedSWF('<?php echo Yii::app()->theme->baseUrl;?>/piecemaker.swf', 'piecemaker', '960', '430', '10', null, flashvars,    
  params, null);
    ...
    <div class="shout-box">
	  ...
	  <div class="row-fluid">
       ...
       <div class="span3">
            ...
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/fatcow/wordpress.png" width="32" height="32" alt="Wordpress" />
            <h3>
            Wordpress themes
            </h3>
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/fatcow/blogger.png" width="32" height="32" alt="Blogger" />
            <h3>
            Blogger themes
            </h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/fatcow/css_3.png" width="32" height="32" alt="CSS3" />
            <h3>
            CSS3 themes
            </h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/fatcow/html_5.png" width="32" height="32" alt="HTML5" />
            <h3>
            HTML5 themes
            </h3>
